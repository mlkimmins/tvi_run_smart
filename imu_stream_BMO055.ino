...
//    Serial.println(incomingByte);
  ...
  if (!is_stop){
    ...
    Serial.print("gyro_x= ");
    Serial.print(angVelocityData.acceleration.x);
    Serial.print(",");
    Serial.print("gyro_y= ");
    Serial.print(angVelocityData.acceleration.y);
    Serial.print(",");
    Serial.print("gyro_z= ");
    Serial.print(angVelocityData.acceleration.z);
    Serial.print(",");
    ...
    Serial.print(",");
    Serial.print("mag_z= ");
    Serial.print(magnetometerData.magnetic.z);
    Serial.print(",");
...
void printEvent(sensors_event_t* event) {
  ...
  Serial.println(z);
//  Serial.print(",");
//  Serial.print("integration_accel_z= ");
//  integration_z += z;
//  Serial.println(integration_z);
